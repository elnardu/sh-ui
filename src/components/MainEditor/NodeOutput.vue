<template>
  <div class="output">
    ...
    <el-button-group v-if="this.obj.name === 'bool'">
      <el-button :type="obj.payload ? 'primary' : 'secondary'" @click="setTrue">True</el-button>
      <el-button :type="!obj.payload ? 'primary' : 'secondary'" @click="setFalse">False</el-button>
    </el-button-group>
